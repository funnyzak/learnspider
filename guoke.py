...
gk_img_url = []
bfinish = 0
fetchImgUrl_re = re.compile('''<img src="([\w\/\.\?\-\:]*)"''')
contentUrl_re = re.compile('''<a class="title-link" href="([\w\/\.\:]*)"''')
nextIndex_re = re.compile('''<a href="([\/\w\?\=]*)">下一页</a>''')
main_url = "http://www.guokr.com"
startpage = ""
